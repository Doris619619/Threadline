...
在创建、修改、删除或提交仓库文件前，必须完整阅读并严格遵守 [docs/工程协作规范.md](docs/%E5%B7%A5%E7%A8%8B%E5%8D%8F%E4%BD%9C%E8%A7%84%E8%8C%83.md)。其中的文件与函数说明、职责拆分、分支命名、README/docs 同步维护及完成修改后必须提交的规则，均为强制要求。
