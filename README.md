...
- **字体与外观**：「设置 → 外观」可独立选择默认蓝色／安妮雅／皮卡小屋主题和默认字体／思源黑体／思源宋体，按设备保存，同源标签页同步；三套主题都支持浅色、深色与跟随系统。手机正文 17px、页面标题 28px，并支持文字放大。字体与角色插画本地分发，没有下载 Apple 字体；真机 Dynamic Type 与捏合缩放仍单独验收。详见[外观说明](docs/appearance.md)。皮卡小屋保持原有任务布局，将像素家具图标、游戏窗框、勾选反馈融入界面；侧栏或手机「更多 → 我的装扮」可切换三套穿搭、和白猫互动。见[皮卡小屋设计](docs/pixel-cottage.md)。
...
设置 → 外观可用按钮切换浅色、深色或跟随系统，明暗模式与蓝色 / 安妮雅 / 皮卡小屋配色独立保存。
